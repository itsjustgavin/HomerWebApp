...
<div class="w3-container" align="left" style="width: 95%">
		<div id ="heroCard" class="w3-card-4 text-light bg-dark rounded" style="width: 12%">
			<div class="w3-container w3-center">
				<img src="https://myhomerimagebucket.s3.amazonaws.com/HD-wallpaper-marvel-phoenix-comics-dark-phoenix-jean-grey-marvel-marvel-girl-mcu-phoenix-force.jpg" 
				alt="Avatar" style="width: 65%">
